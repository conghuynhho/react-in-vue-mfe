<template>
  <div>
    ...
    <!-- <LoadMFEWebComponent
      web-component-name="react-button"
      :import-function="importButtonFunction"
      label="Click me"
    ...
    <!-- <ReactComponent
      ...
      :import-function="importBannerFunction"
      :store="store"
    /> -->
    <br />
    <MountReactComponent
...
<script>
// import LoadMFEWebComponent from './web-component/LoadMFEWebComponent.vue'
// import ReactComponent from './react-module/ReactComponent.vue'
...
export default {
  ...
  methods: {
    async importBannerFunction() {
      return import('reactModule2/Banner')
    },
    // async importButtonFunction() {
    //   const generateButton = await import('reactModule/Button').then(module => module.default)
    //   return generateButton(this.store)
    // },
    async importBanner2Function(element) {
      const mountFunction = await import('reactModule2/Banner2').then(module => module.default)
      console.log('mountFunction', element)
